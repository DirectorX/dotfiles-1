...
static const char selbordercolor[]  = "#81a2be";// border color when select
static const char selbgcolor[]      = "#3e4451";// background of bar when selected
static const char selfgcolor[]      = "#c8ccd4";// font color in bar
...
/* tagging */
static const char *tags[] = { "Code", "Fun", "Candy", ".", ".", ".", ".", ".", "Internet" };
